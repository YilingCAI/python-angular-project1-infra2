...
argocd_hostname           = "argocd.k8s-mypythonproject1d-c66717b353-1009008254.us-east-1.elb.amazonaws.com.nip.io" # REPLACE 127.0.0.1 with real ALB IP
...
argocd_app_path     = "apps/dev"

# EKS cluster-admin access for human operators (kubectl)
admin_iam_arns = [
  "arn:aws:iam::284464749723:user/cloud_user",
]
